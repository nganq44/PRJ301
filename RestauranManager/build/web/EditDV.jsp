                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="CRUD" method="GET">
                                        ...
                                        <div class="form-outline mb-4">
                                            <select name="idHD" class="form-control form-control-lg" readonly>
                                                <%
                                        ...
                                        <div class="form-outline mb-4">
                                             <input name="name" type="text" class="form-control form-control-lg" placeholder="Giá Dịch Vụ" value="<%= dtoDV.getTenDV()%>" required/>
